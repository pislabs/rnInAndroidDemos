 ...
 */
public class TurnReactDelegate {
...
//    private boolean mFabricEnabled = ReactNativeFeatureFlags.enableFabricRenderer();
     ...
     * either use {@link com.facebook.react.ReactDelegate#ReactDelegate(Activity, ReactHost, String, Bundle)} if you're
     * on bridgeless mode or {@link com.facebook.react.ReactDelegate#ReactDelegate(Activity, ReactNativeHost, String,
...
//            }
    ...
    /** Start the React surface with the app key supplied in the {@link com.facebook.react.ReactDelegate} constructor. */
    public void loadApp() {
...
//        }
    ...
    /** Stop the React surface started with {@link com.facebook.react.ReactDelegate#loadApp()}. */
...
//        }
    ...
    protected ReactRootView createRootView() {
        ReactRootView reactRootView = new TurnView(mActivity);
