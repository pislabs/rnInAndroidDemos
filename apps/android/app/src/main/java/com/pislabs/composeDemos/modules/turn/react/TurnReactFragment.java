 ...
 */
public class TurnReactFragment extends Fragment implements PermissionAwareActivity {
    ...
    protected TurnReactDelegate mReactDelegate;

    private boolean mDisableHostLifecycleEvents;

    @Nullable private PermissionListener mPermissionListener;

    public TurnReactFragment() {
     ...
     */
    private static TurnReactFragment newInstance(
            String componentName, Bundle launchOptions, Boolean fabricEnabled) {
        TurnReactFragment fragment = new TurnReactFragment();
...
//        }
    ...
    protected TurnReactDelegate getReactDelegate() {
...
//            mReactDelegate.unloadApp();
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public TurnReactFragment.Builder setComponentName(String componentName) {
         ...
         * @return Builder
         */
        public TurnReactFragment.Builder setLaunchOptions(Bundle launchOptions) {
            mLaunchOptions = launchOptions;
            return this;
        }

        public TurnReactFragment build() {
            return TurnReactFragment.newInstance(mComponentName, mLaunchOptions, mFabricEnabled);
        }

        public TurnReactFragment.Builder setFabricEnabled(boolean fabricEnabled) {
